  ...
  - **Sub-commands:**
    ...
    - **`refresh`**:
      - **Description:** Reload the hierarchical instructional memory from all
        ...
        with the latest `terminaI.md` content.
    - **`list`**:
      - **Description:** Lists the paths of the terminaI.md files in use for
        hierarchical memory.
    - **Note:** For more details on how `terminaI.md` files contribute to
...
- **`/init`**
  - **Description:** To help users easily create a `terminaI.md` file, this
