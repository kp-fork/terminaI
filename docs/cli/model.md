...
| ----------------- | -------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| Auto (Gemini 3)   | Let the system choose the best Gemini 3 model for your task.   | gemini-2.0-flash-exp-pro-preview (if enabled), gemini-2.0-flash-exp-flash-preview (if enabled) |
...
> [Gemini 3 on Gemini CLI](../get-started/gemini-2.0-flash-exp.md).
