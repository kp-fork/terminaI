    ...
    properties: {
      provider: {
        ...
        options: [
          ...
          { value: 'openai_chatgpt_oauth', label: 'ChatGPT (OAuth)' },
      ...
      openaiChatgptOauth: {
        type: 'object',
        label: 'ChatGPT OAuth Settings',
        category: 'Model',
        requiresRestart: true,
        default: {},
        description: 'Settings for ChatGPT OAuth (Codex backend) provider.',
        showInDialog: false,
        properties: {
          baseUrl: {
            type: 'string',
          ...
          model: {
            ...
            requiresRestart: true,
            default: undefined as string | undefined,
            description: 'The model ID for Codex backend (e.g. gpt-5.2-codex).',
            showInDialog: true,
          },
          internalModel: {
            type: 'string',
