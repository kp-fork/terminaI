  ...
  tools: {
    ...
    properties: {
      ...
      repl: {
        ...
        requiresRestart: false,
        default: {},
        description: 'Settings for REPL execution.',
        showInDialog: false,
        properties: {
          sandboxTier: {
            type: 'string',
            label: 'REPL Sandbox Tier',
            category: 'Tools',
            requiresRestart: false,
            default: 'tier1' as string | undefined,
            description:
              'Select the REPL sandbox tier (tier1 local temp sandbox, tier2 Docker).',
            showInDialog: false,
          },
          timeoutSeconds: {
            type: 'number',
            label: 'REPL Timeout (Seconds)',
            category: 'Tools',
            requiresRestart: false,
            default: 30,
      ...
      guiAutomation: {
        ...
        properties: {
          ...
          minReviewLevel: {
            type: 'enum',
            label: 'Minimum Review Level',
            category: 'Tools',
            requiresRestart: true,
            default: 'B',
            description:
              'Default minimum review level for GUI automation tools.',
            showInDialog: false,
            options: [
          ...
          clickMinReviewLevel: {
            type: 'enum',
            label: 'Click Minimum Review Level',
            category: 'Tools',
            requiresRestart: true,
            default: 'B',
          ...
          typeMinReviewLevel: {
            type: 'enum',
            label: 'Type Minimum Review Level',
            category: 'Tools',
            requiresRestart: true,
            default: 'B',
          ...
          redactTypedTextByDefault: {
            type: 'boolean',
            label: 'Redact Typed Text by Default',
            category: 'Tools',
            requiresRestart: true,
            default: true,
          ...
          snapshotMaxNodes: {
            ...
            default: 100,
            description:
              'Maximum number of nodes included in UI snapshots. Applies both in the driver and as a core backstop.',
            showInDialog: false,
          },
          maxActionsPerMinute: {
            type: 'number',
      ...
      enableHooks: {
        ...
        default: false,
        description:
          'Enable the hooks system for intercepting and customizing TerminaI behavior. When enabled, hooks configured in settings will execute at appropriate lifecycle events (BeforeTool, AfterTool, BeforeModel, etc.). Requires MessageBus integration.',
        showInDialog: false,
      },
    },
  },
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the TerminaI extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for TerminaI.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling TerminaI output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',
