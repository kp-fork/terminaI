        ...
        {activeTab === "settings" ? (
          ...
          <div className="p-3 space-y-2">
            <div className="flex items-center justify-between px-2 mb-2">
              <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wide">Recent Sessions</span>
              {sessions.length > 0 && (
                <button 
            ...
            {sessions.length > 0 ? (
              ...
              <div className="text-center py-12 px-4">
                ...
                <div className="text-muted-foreground text-sm font-medium">No session history yet</div>
