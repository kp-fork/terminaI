...
export function LeftSidebar({ onCommandSelect }: LeftSidebarProps) {
  ...
  const [settingsCategory, setSettingsCategory] = useState<'app' | 'cli'>(
    'app',
  );
              ...
              <div className="p-3 space-y-2">
                ...
                <div className="space-y-1">
                  ...
                  <CommandItem
                    ...
                    category="Conversation"
                    onClick={() => onCommandSelect?.('/clear')}
                  />
                  <CommandItem
                    command="/checkpoint"
                    description="Save conversation state"
                    category="Conversation"
                    onClick={() => onCommandSelect?.('/checkpoint')}
                  />
                </div>
                ...
                <div className="space-y-1 mt-3">
                  <CommandItem
                    ...
                    category="Security"
                    onClick={() => onCommandSelect?.('/trust')}
                  />
                  <CommandItem
                    command="/untrust"
                    description="Revoke folder trust"
                    category="Security"
                    onClick={() => onCommandSelect?.('/untrust')}
                  />
                </div>
                ...
                <div className="space-y-1 mt-3">
                  <CommandItem
                    ...
                    category="Sessions"
                    onClick={() => onCommandSelect?.('/sessions list')}
                  />
                  <CommandItem
                    command="/sessions stop"
                    description="Stop a session"
                    category="Sessions"
                    onClick={() => onCommandSelect?.('/sessions stop')}
                  />
                </div>
              ...
              <div className="space-y-1">
                {sessions.map((session) => (
                  <div
                    ...
                    onClick={() => onCommandSelect?.(`/restore ${session.id}`)}
                  >
